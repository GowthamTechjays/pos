            ...
            >
              <div className="create-partnership-info-form">
                <div className="create-partnership-info-field">
                  <div>{PartnerShipCoordinatorInfoLabels.coordinatorname}</div>
                  <div>
                    <Field
                      type="text"
                ...
                <div className="create-partnership-info-field">
                  <div>{PartnerShipCoordinatorInfoLabels.email}</div>
                  <div>
                    <Field
                      type="email"
                      name="email"
                ...
                <div className="create-partnership-info-field">
                  <div>{PartnerShipCoordinatorInfoLabels.role}</div>
                  <div>
                    <Select
                      value={role}
                ...
                <div className="create-partnership-info-field">
                  <div>{PartnerShipCoordinatorInfoLabels.companyName}</div>
                  <div>
                    <Select
                      value={companyName}
                ...
                <div className="create-partnership-info-button-container">
                  <SecondaryButton
                    onClick={() =>
                      history.push(
                        `/createPartnership?form=CompanyPartnerInfo&type=update&partner_ship_id=${partnershipId}`
                      )
                    }
